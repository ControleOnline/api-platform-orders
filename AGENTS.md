...
- O serializer de leitura de `Order` deve expor `mainOrder.external_code` nos groups usados por listagem e detalhe. Esse valor e o numero da comanda e nao deve depender de `otherInformations` no frontend.
