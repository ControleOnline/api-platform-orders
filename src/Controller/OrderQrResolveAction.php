...
/**
 * POST /order_qr_contexts/resolve — public resolve of opaque token (no order creation).
 */
class OrderQrResolveAction
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            ...
            // Reject client authority fields if present
            foreach (['company', 'provider', 'providerId', 'mainOrder', 'mainOrderId', 'local'] as $forbidden) {
            ...
            $public = $this->orderQrService->resolve($token);

            return new JsonResponse(['context' => $public], Response::HTTP_OK);
