...
class MarkOrderAsPaidServiceTest extends TestCase
{
    ...
    public function testApplyPaidOrderStatusUsesOpenPaid(): void
    {
        ...
        $this->invokeApply($order);
    }

    public function testApplyPaidOrderStatusDoesNotFallBackToClosedClosed(): void
    {
        $order = $this->createMock(Order::class);
    ...
    private function invokeApply(Order $order): void
    {
        $method = new ReflectionMethod(MarkOrderAsPaidService::class, 'applyPaidOrderStatus');
